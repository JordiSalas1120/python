    ...
    if imagen_A6 is not None:
        ...
        for c_2 in contorno2:
            ...
            if area<14948 and area>14000:
                ...
                cv2.putText(imagen_A6, "BS/. 2",(x,y) , font, 0.75, (0,255,0),2)
                suma1=suma1+2
            
            if area<12800 and area>10900:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "BS/. 1",(x,y) , font, 0.75, (0,255,0),2)
                suma2=suma2+1
            
            if area<10000 and area>8900:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "BS/. 0.5",(x,y) , font, 0.75, (0,255,0),2)
                suma3=suma3+0.5
        total=suma1+suma2
